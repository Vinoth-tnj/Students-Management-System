...
if (strlen($_SESSION['sturecmsaid']==0)) {
    ...
    if(isset($_POST['submit']))
  {
    ...
    $AName=$_POST['staff_name'];
  $email=$_POST['email'];
  $sql="update tblstaff set staff_name=:staff_name,email=:email where id=:aid";
     $query = $dbh->prepare($sql);
     $query->bindParam(':staff_name',$AName,PDO::PARAM_STR);
...
{               ?>
                      <div class="form-group">
                        ...
                        <input type="text" name="staff_name" value="<?php  echo $row->staff_name;?>" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
