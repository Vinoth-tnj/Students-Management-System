...
$query2->execute();
$results2=$query2->fetchAll(PDO::FETCH_OBJ);
$totstaff=$query2->rowCount();
?>
                          <span class="report-title">Total Staffs</span>
                          <h4><?php echo htmlentities($totstaff);?></h4>
                          <a href="manage-staff.php"><span class="report-count"> View Staffs</span></a>
                        </div>
...
?>
                          ...
                          <h4><?php //echo htmlentities($totstu);?></h4>
                          <a href="view-allstudents.php"><span class="report-count"> View Academics</span></a>
                        </div>
...
?> -->
                          ...
                          <a href="mark-graph.php"><span class="report-count"> View Graph</span></a>
                        </div> -->
                        <!-- <div class="inner-card-icon bg-primary">
