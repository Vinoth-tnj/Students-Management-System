        ...
        <table>
            <tr>
                ...
                <select name="subject" id="">
                    ...
                    <option value="Programming in C">OS Concepts</option>
...
<div class="back fix">
        <p style="text-align:center"><a href="staff_view-allstudent.php"><button class="editbtn">Back to list</button></a></p>
    </div>
</div>
        </div>
        <!-- main-panel ends -->
