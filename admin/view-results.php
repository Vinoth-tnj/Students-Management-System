...
?>
  ...
  <body>
	...
	<div>
	<p style="float:left;margin:0 0 5px 0;width:100%;text-align:center;"><a href="view-cgpa.php?vr=<?php echo $stid; ?>&vn=<?php echo $name; ?>"><button class="editbtn">View cgpa & completed course</button></a></p>
	</div>
	...
	//select semester
		...
		?>
			<p style="float:left; text-align:right;margin:20px 0;width:49%"><a href="result-update.php?ar=<?php echo $stid?>&seme=<?php echo $semester?>&vn=<?php echo $name?>"><button class="editbtn">Edit Result</button></a></p>
		<?php 
				}
		?>
		
			<p style="float:right;text-align:left;margin:20px 0;width:49%"><a href="view-allstudents.php"><button class="editbtn">Back to list</button></a></p>
