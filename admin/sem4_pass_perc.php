...
$sqlQuery = "SELECT * FROM result WHERE semester=4";
...
foreach ($result as $row) {
	if($row['sub'] == "English Communication-IV")
    {
        $count1_total++;
    }
    if($row['sub'] == "English Communication-IV" && $row['marks']>=50)
    {
        $count1_pass++;
    }
    if($row['sub'] == "OOAD")
    ...
    if($row['sub'] == "OOAD" && $row['marks']>=50)
    {
        $count2_pass++;
    }
    if($row['sub'] == "Computer Networks")
    {
        $count3_total++;
    }
    if($row['sub'] == "Computer Networks" && $row['marks']>=50)
    {
        $count3_pass++;
    }
    if($row['sub'] == "Fundamentals of Relational DBMS")
    {
        $count4_total++;
    }
    if($row['sub'] == "Fundamentals of Relational DBMS" && $row['marks']>=50)
    {
        $count4_pass++;
    }
    if($row['sub'] == "Visual Programming")
    {
        $count5_total++;
    }
    if($row['sub'] == "Visual Programming" && $row['marks']>=50)
    {
        $count5_pass++;
    }
    
    if($row['sub'] == "Visual Programming Lab")
    {
        $count6_total++;
    }
    if($row['sub'] == "Visual Programming Lab" && $row['marks']>=50)
    {
        $count6_pass++;
    }
    if($row['sub'] == "Fundamentals of Relational DBMS Lab")
    {
        $count7_total++;
    }
    if($row['sub'] == "Fundamentals of Relational DBMS Lab" && $row['marks']>=50)
    {
        $count7_pass++;
    }
    if($row['sub'] == "Personality Development -IV")
    {
        $count8_total++;
    }
    if($row['sub'] == "Personality Development -IV" && $row['marks']>=50)
    {
        $count8_pass++;
    }
}
$datas = array();
$sub = array("English Communication-IV","OOAD","Computer Networks","Fundamentals of Relational DBMS","Visual Programming","Visual Programming Lab","Fundamentals of Relational DBMS Lab","Personality Development -IV");
