...
{               ?>
            ...
            <!-- <li class="nav-item">
              ...
              <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="view-allstudent.php">Add Results</a></li>
                  <li class="nav-item"> <a class="nav-link" href="view-allstudents.php">View Results</a></li>
                  <li class="nav-item"> <a class="nav-link" href="mark-graph.php">Graph View</a></li>
                </ul>
              </div>
            </li> -->
            <!-- <li class="nav-item">
