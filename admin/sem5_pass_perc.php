...
$sqlQuery = "SELECT * FROM result WHERE semester=5";
...
foreach ($result as $row) {
	if($row['sub'] == "Java Programming")
    {
        $count1_total++;
    }
    if($row['sub'] == "Java Programming" && $row['marks']>=50)
    {
        $count1_pass++;
    }
    if($row['sub'] == "Basics of Software Engineering")
    {
        $count2_total++;
    }
    if($row['sub'] == "Basics of Software Engineering" && $row['marks']>=50)
    {
        $count2_pass++;
    }
    if($row['sub'] == "Elective -I")
    {
        $count3_total++;
    }
    if($row['sub'] == "Elective -I" && $row['marks']>=50)
    {
        $count3_pass++;
    }
    if($row['sub'] == "Web Technology")
    {
        $count4_total++;
    }
    if($row['sub'] == "Web Technology" && $row['marks']>=50)
    {
        $count4_pass++;
    }
    if($row['sub'] == "Java Programming Lab")
    {
        $count5_total++;
    }
    if($row['sub'] == "Java Programming Lab" && $row['marks']>=50)
    {
        $count5_pass++;
    }
    
    if($row['sub'] == "Environmental Studies")
    {
        $count6_total++;
    }
    if($row['sub'] == "Environmental Studies" && $row['marks']>=50)
    {
        $count6_pass++;
    }
    if($row['sub'] == "Web Technology Lab")
    {
        $count7_total++;
    }
    if($row['sub'] == "Web Technology Lab" && $row['marks']>=50)
    {
        $count7_pass++;
    }
    if($row['sub'] == "English Communication-V")
    {
        $count8_total++;
    }
    if($row['sub'] == "English Communication-V" && $row['marks']>=50)
    {
        $count8_pass++;
    }
}
$datas = array();
$sub = array("Java Programming","Basics of Software Engineering","Elective -I","Web Technology","Java Programming Lab","Environmental Studies","Web Technology Lab","English Communication-V");
